...
const Audio = () => {
        ...
        const data = [
            {
                title: "1. What are payment service providers (PSPs)?",
                content: "Payment service providers facilitate digital transactions by offering infrastructure to merchants for accepting payments through various methods like UPI, credit/debit cards, net banking, and wallets."
            },
            {
                title: "2. How do PSPs differ from payment gateways?",
                content: "Payment gateways are technology platforms that authorize payments, whereas PSPs aggregate multiple payment options, including gateways, and provide a broader range of services like reconciliation, fraud management, and payout solutions."
            },
            {
                title: "4. Which are some leading PSPs in India?",
                content: "Popular PSPs include Haoda Pay, Razorpay, Paytm Payment Gateway, CCAvenue, Instamojo."
            },
            {
                title: "5. How are payout services integrated with PSPs?",
                content: "Payout services allow businesses to disburse payments like salaries, daily wages, and vendor incentives directly to recipients' bank accounts using APIs, reducing manual processes."
            },
        ]
  ...
  return (
    <div className=''>
        ...
        <div className='banner__section'>
            ...
            <div className='banner__content h-full grid place-content-center px-10'>
...
<span className='block slider__imgTitle'>Fantasy Kabaddi</span>
        ...
        <div className='section3'>
            <div className='section3 grid place-content-center'>
        ...
        <div className='partner__viewContainer grid place-content-center'>
        ...
        <div className=''>
            <div className='faq__viewCon container mx-auto px-5 flex'>
                ...
                <div  className='w-full lg:w-1/2'>
                    ...
                    <div>
                        <div className='flex justify-center items-center flex-col mt-10 gap-8'>
                            {data.map((item, id) => (
                                <div className='faq__viewContainer pt-5 px-5 my-2' key={ id }>
        ...
        <div className='section'>
            <div className='footer__section'>
                                ...
                                <div className='flex flex-wrap sm:flex-nowrap gap-20 lg:gap-40'>
                                    <div>
                                        ...
                                        <div className='flex flex-col gap-5'>
                                            <span className='block footer__content'>Game</span>
                                            <span className='block footer__content'>About us</span>
                                        </div>
                                    </div>
                                    <div>
                                        <span className='block footer__title'>Help</span>
                                        <div className='flex flex-col gap-5'>
                                            <span className='block footer__content'>Customer Support</span>
                                            <span className='block footer__content'>Terms & Conditions</span>
                                            <span className='block footer__content'>Privacy Policy</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <span className='copy__rights block'>© Copyright 2025, All Rights Reserved by Haoda Network</span>
